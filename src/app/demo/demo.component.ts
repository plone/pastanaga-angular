...
export class DemoComponent implements OnInit {
    ...
    categorizedGroup: ControlModel[] = [
        ...
        new ControlModel({
            id: 'america', label: 'America', children: [
    ...
    avatars: Avatar[] = [
        ...
        new Avatar({username: 'With lock', image: of(b64toBlob(this.IMAGE_PORTRAIT, 'image/gif')), badgeIcon: 'lock'}),
