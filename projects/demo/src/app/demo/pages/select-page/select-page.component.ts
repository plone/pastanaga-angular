...
>
    ...
    <pa-option (select)="selectedValue1 = 'User 1'">User 1</pa-option>
    <pa-option (select)="selectedValue1 = 'User 2'">User 2</pa-option>
    <pa-option (select)="selectedValue1 = 'User 3'">User 3</pa-option>
    <pa-option-header>Groups</pa-option-header>
    <pa-option (select)="selectedValue1 = 'Group 1'">Group 1</pa-option>
    <pa-option (select)="selectedValue1 = 'Group 2'">Group 2</pa-option>
    <pa-option (select)="selectedValue1 = 'Group 3'">Group 3</pa-option>
</pa-select>`;
...
></pa-select>`
    ...
    onSelect($event: { event: MouseEvent | KeyboardEvent; option: OptionModel }) {
        console.log(`Selection:`, $event);
        this.selectedValue2 = $event.option.label;
    }
}
