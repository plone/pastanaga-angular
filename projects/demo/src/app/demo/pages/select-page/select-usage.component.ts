...
@Component({
    ...
    template: `<h4>Inputs</h4>
        <dl>
            ...
            <dt>errorMessages</dt>
            <dd>
                Provides default messages to display for the possible error keys when none is present in the errors
                object. If a message (string) is provided for a given key, it will be displayed rather than the message
                provided in errorMessages.
            </dd>
            ...
            <dt>options</dt>
            <dd>
                Option list to be displayed in the dropdown <small>(optional: can be set directly in the DOM)</small>
            </dd>
