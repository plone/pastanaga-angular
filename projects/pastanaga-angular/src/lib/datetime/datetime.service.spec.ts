    ...
    describe('en-US locale', () => {
        ...
        describe('getFormattedDate method with human param', () => {
            it('should return before yesterday afternoon as a full date with PM', (done) => {
                service.getFormattedDate(dates.beforeYesterdayPM.timestamp, DATE_FORMAT.human).subscribe(formattedDate => {
            ...
            it('should format before yesterday morning as a full date with AM', (done) => {
                service.getFormattedDate(dates.beforeYesterdayAM.timestamp, DATE_FORMAT.human).subscribe(formattedDate => {
        ...
        describe('getFormattedDate method with numerical param', () => {
            it('should return before yesterday afternoon as a numerical date without time', (done) => {
                service.getFormattedDate(dates.beforeYesterdayPM.timestamp, DATE_FORMAT.numerical).subscribe(formattedDate => {
            ...
            it('should format before yesterday morning as a numerical date without time', (done) => {
                service.getFormattedDate(dates.beforeYesterdayAM.timestamp, DATE_FORMAT.numerical).subscribe(formattedDate => {
            ...
            it('should return yesterday morning as yesterday with AM', (done) => {
                service.getFormattedDate(dates.yesterdayAM.timestamp, DATE_FORMAT.numerical).subscribe(formattedDate => {
            ...
            it('should format yesterday afternoon as yesterday with PM', (done) => {
                service.getFormattedDate(dates.yesterdayPM.timestamp, DATE_FORMAT.numerical).subscribe(formattedDate => {
        ...
        describe('getFormattedDate method with mixed param', () => {
            it('should return before yesterday afternoon as a human date (full date with PM)', (done) => {
                service.getFormattedDate(dates.beforeYesterdayPM.timestamp, DATE_FORMAT.mixed).subscribe(formattedDate => {
            ...
            it('should format before yesterday morning as a human date (full date with AM)', (done) => {
                service.getFormattedDate(dates.beforeYesterdayAM.timestamp, DATE_FORMAT.mixed).subscribe(formattedDate => {
            ...
            it('should format few seconds ago as relative time', (done) => {
                service.getFormattedDate(dates.fewSecondsAgo.timestamp, DATE_FORMAT.mixed).subscribe(formattedDate => {
            ...
            it('should format one minute ago as relative time', (done) => {
                service.getFormattedDate(dates.oneMinutesAgo.timestamp, DATE_FORMAT.mixed).subscribe(formattedDate => {
            ...
            it('should format 10 minutes ago as relative time', (done) => {
                service.getFormattedDate(dates.tenMinutesAgo.timestamp, DATE_FORMAT.mixed).subscribe(formattedDate => {
        ...
        describe('getFormattedDate method with absolute param', () => {
            it('should return before yesterday afternoon as a numerical date with PM', (done) => {
                service.getFormattedDate(dates.beforeYesterdayPM.timestamp, DATE_FORMAT.absolute).subscribe(formattedDate => {
            ...
            it('should format before yesterday morning as a numerical date with AM', (done) => {
                service.getFormattedDate(dates.beforeYesterdayAM.timestamp, DATE_FORMAT.absolute).subscribe(formattedDate => {
            ...
            it('should return yesterday morning as a numerical date with AM', (done) => {
                service.getFormattedDate(dates.yesterdayAM.timestamp, DATE_FORMAT.absolute).subscribe(formattedDate => {
            ...
            it('should format yesterday afternoon as a numerical date with PM', (done) => {
                service.getFormattedDate(dates.yesterdayPM.timestamp, DATE_FORMAT.absolute).subscribe(formattedDate => {
        ...
        describe('getFormattedDate method with displaySeconds option set', () => {
            it('should display time with seconds for human format', (done) => {
                service.getFormattedDate(dates.beforeYesterdayPM.timestamp, DATE_FORMAT.human, true).subscribe(formattedHuman => {
            ...
            it('should display no time for numerical format', (done) => {
                service.getFormattedDate(dates.beforeYesterdayPM.timestamp, DATE_FORMAT.numerical, true).subscribe(formattedNumerical => {
            ...
            it('should display time with seconds for absolute format', (done) => {
                service.getFormattedDate(dates.beforeYesterdayPM.timestamp, DATE_FORMAT.absolute, true).subscribe(formattedNumerical => {
