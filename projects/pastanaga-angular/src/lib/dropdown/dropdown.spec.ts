...
const template = `<pa-dropdown>
    ...
    <pa-option disabled icon="globe" id="menu-item-2" (selectOption)="onSelect($event)">Menu list item 2</pa-option>
    <pa-option icon="face-happy" id="menu-item-3" (selectOption)="onSelect($event)">Menu list item 3</pa-option>
    <pa-separator></pa-separator>
    <pa-option icon="trash" destructive id="menu-item-destructive" (selectOption)="onSelect($event)">Menu item destructive</pa-option>
</pa-dropdown>`;
